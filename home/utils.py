...
🔍 Твоя задача:
- Найди только те навыки из резюме, которые совпадают с требованиями вакансии.
- Не включай в список навыков кандидата то, что не указано в описании вакансии.
- Будь строгим: если совпадают меньше 3 навыков — процент <= 40%.
- Если совпадают 3–4 навыка — процент до 60%.
- Только при почти полном совпадении — больше 80%.
- Указывай недостающие навыки только из описания вакансии.
